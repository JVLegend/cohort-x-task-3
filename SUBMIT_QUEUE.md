...
- Relatorio final melhorado: `reports/final-candidates.md` e `reports/final-selection.csv` recomendam ate 20 finais com ancora publica, `v185_private_kw.csv`, anchors historicos suplementados quando a CLI da Kaggle trunca o historico, promocao explicita de ASSOC/DIFF near-best como hedge privado, reservas publicas controladas ate `0.00600` abaixo do melhor e filtro de volume para deixar mutacoes KEEP-only gigantes apenas em Top Public.
