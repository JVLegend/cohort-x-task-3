...
- Shortlist final reforcada: `reports/final-candidates.md` foi regenerado com anchors
  ...
  near-best ate `0.00325` abaixo de `v296`; selecao recomendada atual subiu para 12/20.
...
- Relatorio final melhorado: `reports/final-candidates.md` recomenda ate 20 finais com ancora publica, `v185_private_kw.csv`, anchors historicos suplementados quando a CLI da Kaggle trunca o historico, promocao explicita de ASSOC/DIFF near-best como hedge privado e filtro de volume para deixar mutacoes KEEP-only gigantes apenas em Top Public.
