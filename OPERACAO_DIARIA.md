...
- `final-selection-audit` mede a carteira final: slots, queda publica maxima, mix de roles, slots ASSOC/DIFF, concentracao por condicao e prioridade de troca. Se `condition_concentration=crowded`, nao e bloqueio imediato; e sinal para substituir reservas COPD-only por hedges privados/non-COPD assim que aparecerem candidatos public-neutral.
