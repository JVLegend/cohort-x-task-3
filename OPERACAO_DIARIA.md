...
- `plan-decision-outcome` deve ser lido junto com o scorecard: ele evita promover um arquivo isolado quando uma comparacao pareada por eixo mostra que o ganho veio de outro fator.
