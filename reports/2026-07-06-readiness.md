# CohortX Reset Readiness — 2026-07-06

Tags: #JoaoVictor #Kaggle #Academia #Tecnologia

- Recommended action: `wait_for_target_date`
- Selected plan: `plans/2026-07-06.csv`
- Selected plan items: 20 valid, 20 unsubmitted, 0 duplicate_content
- Quota now: 20/20 used, 0 remaining
- Next reset UTC/BRT: 2026-07-06 00:00:00 UTC / 2026-07-05 21:00:00 BRT
- Deadline UTC/BRT: 2026-07-16 11:59:00 UTC / 2026-07-16 08:59:00 BRT
- Best public: 0.43156
- Public notebooks: new=0, updated=0
- Final selection: 20/20
- Manifest: `reports/2026-07-06-manifest.md` with 20 unique SHA-256 files; drift=0
- Decision matrix: `reports/2026-07-06-decision.md` with 15 matched comparisons
- Auto next plan: `plans/2026-07-07.csv` via `src/v341_360_post_july4_followups.py` start_version=421; contingency_exists=true
...
| quota | ready_at_reset | quota_remaining=0; reset=2026-07-06 00:00:00 UTC |
| selected_plan | ready | plan=`plans/2026-07-06.csv`; valid=20; duplicates=0 |
| manifest | ready | report=`reports/2026-07-06-manifest.md`; hashes=20/20; drift=0 |
| decision_matrix | ready | report=`reports/2026-07-06-decision.md`; matched=15 |
| auto_next_plan | ready | next=`plans/2026-07-07.csv`; script=`src/v341_360_post_july4_followups.py`; start=421; contingency=`plans/2026-07-07-public-contingency.csv`; contingency_exists=true |
...
- Use the selected plan `plans/2026-07-06.csv` unless the preflight switches to a newer primary plan.
...
```text
preflight_date=2026-07-06
current_utc_date=2026-07-05
...
quota_remaining=0
next_quota_reset_utc=2026-07-06 00:00:00 UTC
next_quota_reset_brt=2026-07-05 21:00:00 BRT
best_public=0.43156
primary_plan=plans/2026-07-06.csv
primary_exists=true
primary_valid_items=20
primary_unsubmitted_items=20
primary_duplicate_content_items=0
contingency_plan=plans/2026-07-06-public-contingency.csv
contingency_exists=true
contingency_valid_items=20
contingency_unsubmitted_items=20
contingency_duplicate_content_items=0
reserve_plan=plans/2026-07-06-reserve.csv
