# CohortX Reset Readiness — 2026-07-09

Tags: #JoaoVictor #Kaggle #Academia #Tecnologia

- Recommended action: `wait_for_target_date`
- Selected plan: `plans/2026-07-09-public-contingency.csv`
...
- Manifest: `reports/2026-07-09-public-contingency-manifest.md` with 20 unique SHA-256 files; drift=0
- Decision matrix: `reports/2026-07-09-public-contingency-decision.md` with 1 matched comparisons
- Auto next plan: `plans/2026-07-10.csv` via `src/v341_360_post_july4_followups.py` start_version=541; contingency_exists=true
...
| quota | ready_at_reset | quota_remaining=0; reset=2026-07-09 00:00:00 UTC |
| selected_plan | ready | plan=`plans/2026-07-09-public-contingency.csv`; valid=20; duplicates=0 |
| manifest | ready | report=`reports/2026-07-09-public-contingency-manifest.md`; hashes=20/20; drift=0 |
| decision_matrix | ready | report=`reports/2026-07-09-public-contingency-decision.md`; matched=1 |
| auto_next_plan | ready | next=`plans/2026-07-10.csv`; script=`src/v341_360_post_july4_followups.py`; start=541; contingency=`plans/2026-07-10-public-contingency.csv`; contingency_exists=true |
...
- Use the selected plan `plans/2026-07-09-public-contingency.csv` unless the preflight switches to a newer primary plan.
...
selected_plan_role_overlap_files=12
selected_plan_max_assocdiff_codes=137
