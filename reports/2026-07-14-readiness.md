# CohortX Reset Readiness — 2026-07-14

Tags: #JoaoVictor #Kaggle #Academia #Tecnologia

- Recommended action: `submit_primary`
- Selected plan: `plans/2026-07-14.csv`
- Selected plan items: 20 valid, 20 unsubmitted, 0 duplicate_content
- Quota now: 0/20 used, 20 remaining
- Next reset UTC/BRT: 2026-07-15 00:00:00 UTC / 2026-07-14 21:00:00 BRT
- Deadline UTC/BRT: 2026-07-16 11:59:00 UTC / 2026-07-16 08:59:00 BRT
- Best public: 0.43410
- Public notebooks: new=0, updated=0
- Final selection: 20/20
- Manifest: `reports/2026-07-14-manifest.md` with 20 unique SHA-256 files; drift=0
- Decision matrix: `reports/2026-07-14-decision.md` with 0 matched comparisons
- Auto next plan: `plans/2026-07-15.csv` via `src/v341_360_post_july4_followups.py` start_version=741; contingency_exists=true
...
| quota | ready_now | quota_remaining=20; reset=2026-07-15 00:00:00 UTC |
| selected_plan | ready | plan=`plans/2026-07-14.csv`; valid=20; duplicates=0 |
| manifest | ready | report=`reports/2026-07-14-manifest.md`; hashes=20/20; drift=0 |
| decision_matrix | thin | report=`reports/2026-07-14-decision.md`; matched=0 |
| auto_next_plan | ready | next=`plans/2026-07-15.csv`; script=`src/v341_360_post_july4_followups.py`; start=741; contingency=`plans/2026-07-15-public-contingency.csv`; contingency_exists=true |
...
- Use the selected plan `plans/2026-07-14.csv` unless the preflight switches to a newer primary plan.
...
quota_remaining=20
next_quota_reset_utc=2026-07-15 00:00:00 UTC
next_quota_reset_brt=2026-07-14 21:00:00 BRT
best_public=0.43410
primary_plan=plans/2026-07-14.csv
primary_exists=true
primary_valid_items=20
primary_unsubmitted_items=20
primary_duplicate_content_items=0
contingency_plan=plans/2026-07-14-public-contingency.csv
contingency_exists=true
contingency_valid_items=20
contingency_unsubmitted_items=20
contingency_duplicate_content_items=0
reserve_plan=plans/2026-07-14-reserve.csv
reserve_exists=false
reserve_allowed=false
recommended_action=submit_primary
selected_plan=plans/2026-07-14.csv
selected_plan_semantic_role_status=review_assoc_positive
selected_plan_semantic_note=ASSOCIATION_populated_treat_as_related_candidate_not_KEEP_equivalent
selected_plan_semantic_files=20
selected_plan_assoc_populated_files=20
selected_plan_diff_populated_files=0
selected_plan_role_overlap_files=0
selected_plan_max_assocdiff_codes=1
