# CohortX Reset Readiness — 2026-07-12

Tags: #JoaoVictor #Kaggle #Academia #Tecnologia

- Recommended action: `wait_for_target_date`
- Selected plan: `plans/2026-07-12.csv`
- Selected plan items: 20 valid, 20 unsubmitted, 0 duplicate_content
- Quota now: 20/20 used, 0 remaining
- Next reset UTC/BRT: 2026-07-12 00:00:00 UTC / 2026-07-11 21:00:00 BRT
- Deadline UTC/BRT: 2026-07-16 11:59:00 UTC / 2026-07-16 08:59:00 BRT
- Best public: 0.43342
- Public notebooks: new=0, updated=0
- Final selection: 20/20
- Manifest: `reports/2026-07-12-manifest.md` with 20 unique SHA-256 files; drift=0
- Decision matrix: `reports/2026-07-12-decision.md` with 4 matched comparisons
- Auto next plan: `plans/2026-07-13.csv` via `src/v341_360_post_july4_followups.py` start_version=661; contingency_exists=true
...
| quota | ready_at_reset | quota_remaining=0; reset=2026-07-12 00:00:00 UTC |
| selected_plan | ready | plan=`plans/2026-07-12.csv`; valid=20; duplicates=0 |
| manifest | ready | report=`reports/2026-07-12-manifest.md`; hashes=20/20; drift=0 |
| decision_matrix | ready | report=`reports/2026-07-12-decision.md`; matched=4 |
| auto_next_plan | ready | next=`plans/2026-07-13.csv`; script=`src/v341_360_post_july4_followups.py`; start=661; contingency=`plans/2026-07-13-public-contingency.csv`; contingency_exists=true |
...
- Use the selected plan `plans/2026-07-12.csv` unless the preflight switches to a newer primary plan.
...
```text
preflight_date=2026-07-12
current_utc_date=2026-07-11
