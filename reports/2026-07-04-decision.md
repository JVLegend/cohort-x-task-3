# CohortX Plan Decision Matrix — 2026-07-04
...
1. Run `.venv/bin/python src/cohortx_ops.py plan-scorecard plans/2026-07-04.csv` after all 20 scores are complete.
2. Run `.venv/bin/python src/cohortx_ops.py plan-decision-outcome plans/2026-07-04.csv` to convert matched comparisons into axis winners.
3. Run `.venv/bin/python src/interpret_plan_scores.py --plan plans/2026-07-04.csv --out reports/2026-07-04-impact.md`.
